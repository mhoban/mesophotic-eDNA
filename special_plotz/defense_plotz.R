...
beta_pairs_composite$all$sim %>%
  iwalk(~{
    plotz <- .y
    ggsave(str_glue("~/projects/dissertation/defense/presentation/img/beta_{plotz}.pdf"),.x,device=cairo_pdf,width=12,height=3.5,units="in")
  })
...
cluster_plotz$all$sim %>%
  iwalk(~{
    plotz <- .y
    ggsave(str_glue("~/projects/dissertation/defense/presentation/img/{plotz}_cluster.pdf"),.x,device=cairo_pdf,width=12,height=8,units="in")
  })
ggsave("~/projects/dissertation/defense/presentation/img/fish_cluster_bray.pdf",cluster_plotz$all$bray$fish,device=cairo_pdf,width=12,height=8,units="in")
...
ggsave("~/projects/dissertation/defense/presentation/img/animal_clusters.pdf",animal_clusters,device=cairo_pdf,width=12,height=6,units="in")
...
benthic_clusters
ggsave("~/projects/dissertation/defense/presentation/img/benthic_clusters.pdf",benthic_clusters,device=cairo_pdf,width=12,height=7,units="in")
...
fish_ord <- ord_zone_composite$all$sim$depth_zone$fish +
  ...
  plot_layout(guides="collect") & 
  plotz_theme("transparent")
ggsave("~/projects/dissertation/defense/presentation/img/fish_zone.pdf",fish_ord,device=cairo_pdf,width=10,height=6,units="in")
fish_ord2 <- ord_zone_composite$all$bray$depth_zone$fish +
  ord_zone_composite$all$bray$depth_zone45$fish +
  plot_layout(guides="collect") & 
  plotz_theme("transparent")
ggsave("~/projects/dissertation/defense/presentation/img/fish_zone_bray.pdf",ord_zone_composite$all$bray$depth_zone45$fish,device=cairo_pdf,width=8,height=6,units="in")

ord_zone_composite$all$sim$depth_zone45 %>%
  iwalk(~{
    plotz <- .y
    ggsave(str_glue("~/projects/dissertation/defense/presentation/img/{plotz}_ord_all.pdf"),.x,device=cairo_pdf,width=12,height=8,units="in")
  })
...
ord_composite$all$sim %>%
  iwalk(~{
    plotz <- .y
    ggsave(str_glue("~/projects/dissertation/defense/presentation/img/{plotz}_ord_depth.pdf"),.x,device=cairo_pdf,width=12,height=8,units="in")
  })

ord_composite$all$bray$fish
ggsave("~/projects/dissertation/defense/presentation/img/fish_ord.pdf",ord_composite$all$sim$fish,device=cairo_pdf,width=12,height=10,units="in")
ggsave("~/projects/dissertation/defense/presentation/img/fish_ord_bray.pdf",ord_composite$all$bray$fish,device=cairo_pdf,width=12,height=10,units="in")
...
depth_plotz <- ggplot(depth_data) + 
  ...
  xlab("Species") 
depth_plotz
ggsave(path("~/projects/dissertation/defense/presentation/img","fish_depth.pdf"),depth_plotz,device=cairo_pdf,width=12,height=10,units="in")
...
p
ggsave("~/projects/dissertation/defense/presentation/img/marker_percent.pdf",p,device=cairo_pdf,width=9,height=4,units="in")
...
p
ggsave("~/projects/dissertation/defense/presentation/img/marker_percent_geo.pdf",p,device=cairo_pdf,width=9,height=4,units="in")
...
p
ggsave("~/projects/dissertation/defense/presentation/img/marker_percent_hawaii.pdf",p,device=cairo_pdf,width=9,height=4,units="in")
